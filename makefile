...
clean:
	@echo "Cleaning"
	@mv $(BIN_DIR)/apidisk.o $(BIN_DIR)/apidisk.bkp 
	@rm -rf $(LIB_DIR)/*.a $(BIN_DIR)/*.o $(SRC_DIR)/*~ $(INC_DIR)/*~ *~
	@mv $(BIN_DIR)/apidisk.bkp $(BIN_DIR)/apidisk.o 